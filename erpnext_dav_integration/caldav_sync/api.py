...
def refresh_calendar_discovery(dav_account):
    ...
    for cal in calendars:
        dav_doc.append('available_calendars', {
...
def create_caldav_event(event_name, calendar_name):
    ...
    try:
        ...
        frappe.msgprint(
            _("Event created in calendar successfully"),
            alert=True,
            indicator='green'
        )
...
def sync_to_caldav(event_name):
    ...
    try:
        ...
        frappe.msgprint(
            _("Event synced to calendar successfully"),
            alert=True,
            indicator='green'
        )
...
def delete_caldav_event(event_name):
    ...
    try:
        ...
        frappe.msgprint(
            _("Event deleted from calendar successfully"),
            alert=True,
            indicator='green'
        )
...
def refresh_from_caldav(event_name):
    ...
    try:
        ...
        for attendee in caldav_event.get('attendees', []):
            ...
            event.append('caldav_participants_table', {
                'email': email,
                'contact': contact,
        ...
        frappe.msgprint(
            _("Event refreshed from calendar"),
            alert=True,
            indicator='green'
        )
...
def unlink_from_caldav(event_name):
    ...
    frappe.msgprint(
        _("Event disconnected from calendar"),
        alert=True,
        indicator='green'
    )
...
def send_invitation(event_name, participant_email):
    ...
    try:
        ...
        frappe.msgprint(
            _("Invitation sent to {0}").format(participant_email),
            alert=True,
            indicator='green'
        )
