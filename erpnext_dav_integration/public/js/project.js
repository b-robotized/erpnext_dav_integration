...
frappe.ui.form.on("Project", {
    ...
    select_technical_folder(frm) {
        _open_folder_picker(frm,folder_type="technical");
    },
    open_technical_folder(frm) {
        _open_in_nextcloud(frm,folder_type="technical");
    },
    select_organizational_folder(frm) {
        _open_folder_picker(frm,folder_type="organizational");
    },
    open_organizational_folder(frm) {
        _open_in_nextcloud(frm,folder_type="organizational");
    },
...
function _handle_folder_selected(frm, item, base_url, dav_account, folder_type) {
    ...
    frappe.db.set_value("Project", frm.docname, {
