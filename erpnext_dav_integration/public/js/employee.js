frappe.ui.form.on('Employee', {
    select_employee_private_folder(frm) {
        _open_folder_picker(frm,folder_type="private");
    },
    open_employee_private_folder(frm) {
        _open_in_nextcloud(frm,folder_type="private");
    },
    select_company_shared_folder(frm) {
        _open_folder_picker(frm,folder_type="shared");
    },
    open_company_shared_folder(frm) {
        _open_in_nextcloud(frm,folder_type="shared");
    }
});
...
function _handle_folder_selected(frm, item, base_url, dav_account, folder_type) {
    ...
    frappe.db.set_value("Employee", frm.docname, {
